...
<body>
  ...
  <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-dark bg-dark" id="sidenav-main" >
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="{{url('/')}}">
          <img src="{{url('/')}}/asset/front/images/logo1.png" alt="" style="max-width: 142%; max-height: 5rem;">
        </a>
        <div class="lg-auto">
          <!-- Sidenav toggler -->
          <div class="sidenav-toggler d-none d-xl-block" data-action="sidenav-unpin" data-target="#sidenav-main">
            <div class="sidenav-toggler-inner">
            <i class="sidenav-toggler-line bg-orange"></i>
              <i class="sidenav-toggler-line bg-orange"></i>
              <i class="sidenav-toggler-line bg-orange"></i>
            </div>
          </div>
   ...
   <div class="main-content" id="panel" style="background-color:#f7f7f7">
    <!-- Topnav -->
    <nav class="navbar navbar-top navbar-expand " >
      <div class="container-fluid" >
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color:#f7f7f7">
          <!-- Search form -->

          <h3 style="font-size:2.0625rem; ">Dashboard</h3>
